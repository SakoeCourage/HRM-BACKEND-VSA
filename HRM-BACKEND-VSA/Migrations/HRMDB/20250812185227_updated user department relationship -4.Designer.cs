...
namespace HRM_BACKEND_VSA.Migrations.HRMDB
{
    ...
    [Migration("20250812185227_updated user department relationship -4")]
    partial class updateduserdepartmentrelationship4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM_BACKEND_VSA.Entities.User", b =>
                {
                    b.HasOne("HRM_BACKEND_VSA.Entities.Department", null)
                        .WithMany("users")
                        .HasForeignKey("DepartmentId");
